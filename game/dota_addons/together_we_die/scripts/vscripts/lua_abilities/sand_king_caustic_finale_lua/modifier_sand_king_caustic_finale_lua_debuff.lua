...
function modifier_sand_king_caustic_finale_lua_debuff:OnCreated( kv )
	...
	self.damage = self:GetAbility():GetSpecialValueFor( "caustic_finale_damage" ) + (self:GetCaster():GetStrength() * self:GetAbility():GetSpecialValueFor("str_multiplier")) -- special value
	self.damage_exp = self:GetAbility():GetSpecialValueFor( "caustic_finale_damage_expire" )  + (self:GetCaster():GetStrength() * self:GetAbility():GetSpecialValueFor("str_multiplier")) -- special value

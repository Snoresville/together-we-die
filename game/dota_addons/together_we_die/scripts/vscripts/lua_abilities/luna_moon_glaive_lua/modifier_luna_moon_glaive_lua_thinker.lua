...
function modifier_luna_moon_glaive_lua_thinker:OnCreated( kv )
	...
	self.lucent_beam_chance_per_bounce = self:GetAbility():GetSpecialValueFor( "lucent_beam_chance_per_bounce" )
...
function modifier_luna_moon_glaive_lua_thinker:GetModifierProcAttack_Feedback( params )
	...
	if self:GetAbility():IsFullyCastable() and self:RollChance( self.lucent_beam_chance + self.lucent_beam_chance_per_bounce * self.bounce ) then
...
--------------------------------------------------------------------------------
-- Helper
function modifier_luna_moon_glaive_lua_thinker:RollChance( chance )

...
function modifier_phantom_assassin_phantom_strike_lua:GetModifierBaseAttackTimeConstant()
	return self.bat
end
function modifier_phantom_assassin_phantom_strike_lua:GetModifierPreAttack_BonusDamage(params)
	return self:GetParent():GetAgility() * self.agi_multiplier
end
--------------------------------------------------------------------------------
-- Graphics & Animations

...
function modifier_doom_infernal_blade_lua:GetAttributes()
...
function modifier_doom_infernal_blade_lua:OnCreated( kv )
	...
	self.damage = self:GetAbility():GetSpecialValueFor( "burn_damage" ) + self:GetCaster():GetStrength() * self.str_multiplier

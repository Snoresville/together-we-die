...
function queen_of_pain_blink_lua:OnSpellStart()
	...
	-- cast spell
	local scream_of_pain = caster:FindAbilityByName( "queen_of_pain_scream_of_pain_lua" )
	if ( scream_of_pain and scream_of_pain:GetLevel() ~= 0 ) then
		scream_of_pain:OnSpellStart()
	end

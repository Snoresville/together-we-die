...
function modifier_sven_gods_strength_lua:OnCreated( kv )
	...
	self.parent_strength = self:GetParent():GetStrength()
	self.bonus_strength = self.parent_strength * self.str_multiplier
...
function modifier_sven_gods_strength_lua:GetModifierBonusStats_Strength( params )

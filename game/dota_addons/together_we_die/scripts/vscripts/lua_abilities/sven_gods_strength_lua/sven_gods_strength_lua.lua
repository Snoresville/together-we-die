...
LinkLuaModifier( "modifier_sven_gods_strength_lua", "lua_abilities/sven_gods_strength_lua/modifier_sven_gods_strength_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sven_gods_strength_child_lua", "lua_abilities/sven_gods_strength_lua/modifier_sven_gods_strength_child_lua", LUA_MODIFIER_MOTION_NONE )

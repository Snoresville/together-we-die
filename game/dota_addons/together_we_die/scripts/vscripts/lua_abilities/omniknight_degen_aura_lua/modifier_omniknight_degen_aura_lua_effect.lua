...
function modifier_omniknight_degen_aura_lua_effect:GetModifierPreAttack_BonusDamage()
	return  -(self:GetCaster():GetStrength() * self:GetAbility():GetSpecialValueFor( "damage_str_multiplier" ))
end

...
function modifier_puck_dream_coil_lua:OnCreated( kv )
	...
	if caster:HasScepter() then
		...
		self.break_damage = self:GetAbility():GetSpecialValueFor( "coil_break_damage_scepter" ) + caster:GetIntellect() * self:GetAbility():GetSpecialValueFor( "scepter_int_multiplier" ) -- special value
		self.scepter = true
	else
		self.break_radius = self:GetAbility():GetSpecialValueFor( "coil_break_radius" ) -- special value
		self.break_stun = self:GetAbility():GetSpecialValueFor( "coil_stun_duration" ) -- special value
		self.break_damage = self:GetAbility():GetSpecialValueFor( "coil_break_damage" ) + caster:GetIntellect() * self:GetAbility():GetSpecialValueFor( "int_multiplier" ) -- special value
	end

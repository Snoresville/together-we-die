...
--------------------------------------------------------------------------------
function dragon_knight_dragon_tail_lua:GetAOERadius()
...
function dragon_knight_dragon_tail_lua:Hit( target, dragonform )
	...
	-- load data
	local damage = self:GetAbilityDamage() + self:GetSpecialValueFor( "str_multiplier" ) * self:GetCaster():GetStrength()

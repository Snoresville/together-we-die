...
function modifier_omniknight_guardian_angel_lua:OnCreated( kv )
	-- references
	self.regen = self:GetCaster():GetStrength() * self:GetAbility():GetSpecialValueFor("regen_str_multiplier")
...
function modifier_omniknight_guardian_angel_lua:GetModifierConstantHealthRegen()
	return self.regen
end

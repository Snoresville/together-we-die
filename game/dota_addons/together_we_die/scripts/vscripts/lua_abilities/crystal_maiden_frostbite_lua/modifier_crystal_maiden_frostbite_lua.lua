...
function modifier_crystal_maiden_frostbite_lua:OnCreated( kv )
	...
	local tick_damage = self:GetAbility():GetSpecialValueFor( "damage_per_second_tooltip" )  + (caster:GetIntellect() * self:GetAbility():GetSpecialValueFor("int_multiplier")) -- special value
	self.interval = 0.5

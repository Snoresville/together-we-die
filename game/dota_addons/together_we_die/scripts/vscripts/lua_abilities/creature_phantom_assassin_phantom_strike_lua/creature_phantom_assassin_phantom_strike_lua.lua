creature_phantom_assassin_phantom_strike_lua = class({})
LinkLuaModifier("modifier_creature_phantom_assassin_phantom_strike_lua", "lua_abilities/creature_phantom_assassin_phantom_strike_lua/modifier_creature_phantom_assassin_phantom_strike_lua", LUA_MODIFIER_MOTION_NONE)
...
--------------------------------------------------------------------------------
-- Ability Cast Filter
function creature_phantom_assassin_phantom_strike_lua:CastFilterResultTarget(hTarget)
...
function creature_phantom_assassin_phantom_strike_lua:GetCustomCastErrorTarget(hTarget)
    if self:GetCaster() == hTarget then
...
--------------------------------------------------------------------------------
-- Ability Start
function creature_phantom_assassin_phantom_strike_lua:OnSpellStart()
    -- unit identifier
    ...
    if target:GetTeamNumber() ~= caster:GetTeamNumber() then
        caster:AddNewModifier(
                ...
                self, -- ability source
                "modifier_creature_phantom_assassin_phantom_strike_lua", -- modifier name
...
--------------------------------------------------------------------------------
function creature_phantom_assassin_phantom_strike_lua:PlayEffects(origin)
    -- Get Resources

modifier_creature_lina_light_strike_array_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_creature_lina_light_strike_array_lua:IsHidden()
    return true
end

function modifier_creature_lina_light_strike_array_lua:IsPurgable()
    return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_creature_lina_light_strike_array_lua:OnCreated(kv)
    -- references
    local eAbility = self:GetAbility()

    self.stun = eAbility:GetSpecialValueFor("light_strike_array_stun_duration")
    self.damage = eAbility:GetSpecialValueFor("light_strike_array_damage")
...
function modifier_creature_lina_light_strike_array_lua:OnRefresh(kv)

end

function modifier_creature_lina_light_strike_array_lua:OnRemoved()
end

function modifier_creature_lina_light_strike_array_lua:OnDestroy()
    if not IsServer() then
        return
    end
    -- destroy trees
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_creature_lina_light_strike_array_lua:PlayEffects1()
    -- Get Resources
...
function modifier_creature_lina_light_strike_array_lua:PlayEffects2()
    -- Get Resources

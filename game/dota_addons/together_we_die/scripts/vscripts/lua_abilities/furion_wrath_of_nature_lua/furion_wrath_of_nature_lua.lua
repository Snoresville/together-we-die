...
LinkLuaModifier( "modifier_furion_wrath_of_nature_thinker_lua", "lua_abilities/furion_wrath_of_nature_lua/modifier_furion_wrath_of_nature_thinker_lua", LUA_MODIFIER_MOTION_NONE )
...
function furion_wrath_of_nature_lua:GetAssociatedSecondaryAbilities()
	return "lua_abilities/furion_force_of_nature_lua/furion_force_of_nature_lua"
end

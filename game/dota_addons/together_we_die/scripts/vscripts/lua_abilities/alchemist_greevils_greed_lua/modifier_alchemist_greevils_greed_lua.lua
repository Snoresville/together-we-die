...
function modifier_alchemist_greevils_greed_lua:OnIntervalThink()
	...
	self.base_gold = self:GetAbility():GetSpecialValueFor( "bonus_gold" ) + strengthBonusEffect
	self.bonus_gold = self:GetAbility():GetSpecialValueFor( "bonus_bonus_gold" ) + strengthBonusEffect

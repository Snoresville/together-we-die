modifier_creature_dark_willow_bedlam_debuff_lua = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_creature_dark_willow_bedlam_debuff_lua:IsHidden()
	return false
end

function modifier_creature_dark_willow_bedlam_debuff_lua:IsDebuff()
	return true
end

function modifier_creature_dark_willow_bedlam_debuff_lua:IsStunDebuff()
	return false
end

function modifier_creature_dark_willow_bedlam_debuff_lua:IsPurgable()
	return true
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_creature_dark_willow_bedlam_debuff_lua:OnCreated( kv )
...
function modifier_creature_dark_willow_bedlam_debuff_lua:OnRefresh( kv )
	
end

function modifier_creature_dark_willow_bedlam_debuff_lua:OnRemoved()
end

function modifier_creature_dark_willow_bedlam_debuff_lua:OnDestroy()
	if not IsServer() then return end
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_creature_dark_willow_bedlam_debuff_lua:DeclareFunctions()
	local funcs = {
...
function modifier_creature_dark_willow_bedlam_debuff_lua:GetModifierProvidesFOWVision()
	return 1
end
--------------------------------------------------------------------------------
-- Status Effects
function modifier_creature_dark_willow_bedlam_debuff_lua:CheckState()
	local state = {
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_creature_dark_willow_bedlam_debuff_lua:GetStatusEffectName()
	return "particles/status_fx/status_effect_dark_willow_wisp_fear.vpcf"
end

function modifier_creature_dark_willow_bedlam_debuff_lua:PlayEffects()
	-- Get Resources

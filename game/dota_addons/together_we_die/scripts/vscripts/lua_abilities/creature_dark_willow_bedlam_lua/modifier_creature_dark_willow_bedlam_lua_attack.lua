...
--------------------------------------------------------------------------------
modifier_creature_dark_willow_bedlam_lua_attack = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_creature_dark_willow_bedlam_lua_attack:IsHidden()
	return false
end

function modifier_creature_dark_willow_bedlam_lua_attack:IsDebuff()
	return false
end

function modifier_creature_dark_willow_bedlam_lua_attack:IsStunDebuff()
	return false
end

function modifier_creature_dark_willow_bedlam_lua_attack:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_creature_dark_willow_bedlam_lua_attack:OnCreated( kv )
	-- references
...
function modifier_creature_dark_willow_bedlam_lua_attack:OnRefresh( kv )
	-- references
	local damage = self:GetAbility():GetSpecialValueFor( "attack_damage" )
	self.interval = self:GetAbility():GetSpecialValueFor( "attack_interval" )
	self.radius = self:GetAbility():GetSpecialValueFor( "attack_radius" )
...
function modifier_creature_dark_willow_bedlam_lua_attack:OnRemoved()
end

function modifier_creature_dark_willow_bedlam_lua_attack:OnDestroy()
end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_creature_dark_willow_bedlam_lua_attack:OnIntervalThink()
	-- find enemies
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_creature_dark_willow_bedlam_lua_attack:PlayEffects()
	-- Get Resources
...
function modifier_creature_dark_willow_bedlam_lua_attack:PlayEffects1( target, speed )

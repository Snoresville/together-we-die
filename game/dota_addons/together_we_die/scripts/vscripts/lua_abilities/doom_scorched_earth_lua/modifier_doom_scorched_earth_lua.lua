...
function modifier_doom_scorched_earth_lua:GetAttributes()
...
function modifier_doom_scorched_earth_lua:OnCreated( kv )
	...
	local damage = self:GetAbility():GetSpecialValueFor( "damage_per_second" ) + self:GetCaster():GetStrength() * self.str_multiplier

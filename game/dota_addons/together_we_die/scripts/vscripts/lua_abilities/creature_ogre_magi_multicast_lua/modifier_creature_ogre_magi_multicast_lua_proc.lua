--------------------------------------------------------------------------------
modifier_creature_ogre_magi_multicast_lua_proc = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_creature_ogre_magi_multicast_lua_proc:IsHidden()
	return false
end

function modifier_creature_ogre_magi_multicast_lua_proc:IsDebuff()
	return false
end

function modifier_creature_ogre_magi_multicast_lua_proc:IsStunDebuff()
	return false
end

function modifier_creature_ogre_magi_multicast_lua_proc:IsPurgable()
	return true
end

function modifier_creature_ogre_magi_multicast_lua_proc:GetAttributes()
	return MODIFIER_ATTRIBUTE_MULTIPLE
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_creature_ogre_magi_multicast_lua_proc:OnCreated( kv )
...
function modifier_creature_ogre_magi_multicast_lua_proc:OnRefresh( kv )
	
end

function modifier_creature_ogre_magi_multicast_lua_proc:OnRemoved()
end

function modifier_creature_ogre_magi_multicast_lua_proc:OnDestroy()
end

--------------------------------------------------------------------------------
-- Interval Effects
function modifier_creature_ogre_magi_multicast_lua_proc:OnIntervalThink()
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_creature_ogre_magi_multicast_lua_proc:PlayEffects( value )
	value = value + 1

modifier_creature_pudge_rot_lua = class({})
--------------------------------------------------------------------------------

function modifier_creature_pudge_rot_lua:IsDebuff()
...
function modifier_creature_pudge_rot_lua:IsAura()
    if self:GetCaster() == self:GetParent() then
        return true
    end
...
function modifier_creature_pudge_rot_lua:GetModifierAura()
    return "modifier_creature_pudge_rot_lua"
end

--------------------------------------------------------------------------------

function modifier_creature_pudge_rot_lua:GetAuraSearchTeam()
    return DOTA_UNIT_TARGET_TEAM_ENEMY
end

--------------------------------------------------------------------------------

function modifier_creature_pudge_rot_lua:GetAuraSearchType()
    return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC
end

--------------------------------------------------------------------------------

function modifier_creature_pudge_rot_lua:GetAuraRadius()
    return self.rot_radius
end

--------------------------------------------------------------------------------

function modifier_creature_pudge_rot_lua:OnCreated(kv)
    ...
    if IsServer() then
        self.damageTable = {
            ...
            damage = self.rot_tick * self.rot_damage,
...
function modifier_creature_pudge_rot_lua:OnDestroy()
    if IsServer() then
...
function modifier_creature_pudge_rot_lua:DeclareFunctions()
    local funcs = {
...
function modifier_creature_pudge_rot_lua:GetModifierMoveSpeedBonus_Percentage(params)
    if self:GetParent() == self:GetCaster() then
        return 0
    end
...
function modifier_creature_pudge_rot_lua:OnIntervalThink()
    if IsServer() then

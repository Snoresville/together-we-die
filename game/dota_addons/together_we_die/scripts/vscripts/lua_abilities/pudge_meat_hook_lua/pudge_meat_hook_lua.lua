...
LinkLuaModifier( "modifier_pudge_meat_hook_followthrough_lua", "lua_abilities/pudge_meat_hook_lua/modifier_pudge_meat_hook_followthrough_lua", LUA_MODIFIER_MOTION_NONE )

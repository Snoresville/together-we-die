...
function modifier_bane_enfeeble_lua:OnCreated( kv )
	-- references
	self.damage_reduction = -(self:GetAbility():GetSpecialValueFor( "enfeeble_attack_reduction" ) + self:GetAbility():GetSpecialValueFor( "int_multiplier" ) * self:GetCaster():GetIntellect()) -- special value
end

...
function modifier_chaos_knight_reality_rift_lua:OnCreated( kv )
	-- references
	self.reduction = self:GetAbility():GetSpecialValueFor( "armor_reduction" ) - math.floor(self:GetAbility():GetSpecialValueFor( "str_multiplier" ) * self:GetCaster():GetStrength())
end
